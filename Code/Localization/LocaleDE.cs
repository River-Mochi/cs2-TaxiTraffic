            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.ResidentsAvoidTaxis)),
                    ...
                    "**Einige Taxis können bleiben. Laufende Fahrten und normales Warten am Taxistand enden regulär; manche Spielsysteme rufen Taxis unabhängig davon.**"
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.ResetToGameDefaults)),
                    "Setzt Einwohner auf 0 % und schaltet Vermeidung für Pendler und Touristen AUS."
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.ShowLastUpdateInfo)),
                    "Zeigt aktuelle Blockierungen, letzte Änderungen und die Statuszeit."
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.WriteStatusReportAbout)),
                    "Führt den Diagnose-Scan aus und schreibt den vollständigen Statusbericht ins Mod-Log."
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.OpenLogFile)),
                    "Öffnet das Mod-Log. Falls nicht verfügbar, den Logs-Ordner."
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusNotReadyCityScan)),
                    "Stadt öffnen, Simulation kurz laufen lassen, dann Optionen → Status erneut öffnen."
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusNotReadyLastUpdate)),
                    "Details erscheinen, sobald der Status bereit ist."
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusPassengers)),
                    ...
                    "<Lokal> = Fahrgäste aus deiner Stadt.\n" +
                    "<OC> = Pendler und Touristen von Außenverbindungen.\n" +
                    "**Die Gesamtzahl kann wegen Haustieren in Taxis höher sein.**"
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusTaxiSupply)),
                    ...
                    "<Stände> = Taxi-Abhol- und Wartebereiche."
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusOutsideTaxis)),
                    ...
                    "**Im Test kamen bei allen Vermeidungsoptionen auf Maximum kaum oder keine OC-Taxis in die Stadt.**"
                },

                { m_Setting.GetOptionLabelLocaleID(nameof(TaxiSettings.StatusTaxiPurpose)), "Fahrtzweck" },
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusTaxiPurpose)),
                    "Zweck aktueller Taxianfragen.\n" +
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusMonthlyPassengers1)),
                    ...
                    "**Monatliche Bürgerfahrten aus der Verkehrs-Infoansicht.**"
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusMonthlyTourists)),
                    "<Taxi> | <Bus> | <Tram> | <Zug> | <U-Bahn> | <Flug>\n" +
                    "**Monatliche Touristenfahrten aus der Verkehrs-Infoansicht.**"
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusMonthlyTotal)),
                    "<Wartend> = Cims, die gerade auf ÖPNV warten.\n" +
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusCoverage1)),
                    ...
                    "**Aktive Cims, die Taxi Traffic gerade markiert hat. Nicht die gesamte Stadtbevölkerung.**"
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusSnapshotMeta)),
                    "<Aktualisiert> = Zeitpunkt dieser Statusprüfung."
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.StatusDebugMarkedCoverage)),
                    "DEV-Prüfung.\n" +
                    "Aktive Cims = physische Cim-Agenten in der Simulation.\n" +
                    "TT blockiert = Marker von Taxi Traffic.\n" +
                    "IgnoreTaxi jetzt = tatsächliches Vanilla-Flag."
                },
                ...
                { KeyStatusPassengersLine, "{0} gesamt | {1} lokal | {2} OC" },
                ...
                { KeyStatusRequestsLine,
                    "{0} lokaler Fahrgast ({1} blockiert) | {2} OC-Fahrgast ({3} blockiert) |\n" +
                ...
                { KeyStatusTaxiFleetLine,
                    ...
                    "{3} Zuweisung | {4} unterwegs | {5} geparkt"
                },
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(TaxiSettings.OpenDiscord)),
                    "Öffnet den Discord-Support im Browser."
                },
            };
        }
