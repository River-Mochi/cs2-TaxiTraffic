            ...
            return new Dictionary<string, string>
            {
                ...
                // Behavior
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.ResidentsAllowedToUseTaxis)),
                    "Resident households allowed to use taxis"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                        nameof(TaxiSettings.ResidentsAllowedToUseTaxis)),
                    "Controls taxi eligibility for local resident households.\n" +
                    "<0% = households avoid taxis> as much as possible.\n" +
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.BlockCommuters)),
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.BlockTourists)),
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.BlockOutsideTaxis)),
                    "Block outside taxis"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.ResetToGameDefaults)),
                    "Game Defaults"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.EnableDebugLogging)),
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.OpenLogFile)),
                    "Open Log File"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusNotReadyCityScan)),
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusNotReadyTaxiScan)),
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusNotReadyLastUpdate)),
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusMonthlyPassengers1)),
                    "Citizens"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusMonthlyTourists)),
                    "Tourists"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusMonthlyTotal)),
                    "Totals"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusTaxiSupply)),
                    "Taxi supply"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusPassengers)),
                    "Current passengers"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusOutsideControl)),
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusCoverage1)),
                    "Blocking coverage"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                    ...
                    "Group-linked travelers can be temporarily exempt for safe group travel."
                },

                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusWorkDone1)),
                    "Recent cleanup"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusSnapshotMeta)),
                    "Updated"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.WriteStatusReportToLog)),
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusDebugMarkedCoverage)),
                    "Blocking flags (dev)"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.StatusDebugTaxiFlags)),
                    "Taxi flags (dev)"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.NameDisplay)),
                    "Mod"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.VersionDisplay)),
                    "Version"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.OpenParadoxMods)),
                    "Paradox Mods"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
                ...
                {
                    m_Setting.GetOptionLabelLocaleID(
                        nameof(TaxiSettings.OpenDiscord)),
                    "Discord"
                },
                {
                    m_Setting.GetOptionDescLocaleID(
